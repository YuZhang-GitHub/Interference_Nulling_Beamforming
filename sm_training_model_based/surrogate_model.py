...
class GainPred(nn.Module):
    ...
    def __init__(self, M):
        ...
        # M=256: interf: 8/4, signal: 2
        # M=8: interf: 8/4/2, signal: 2 (New: M=8: interf: 8, signal: 2)
        self.H_r = nn.Parameter(torch.randn(self.M, 8))
        self.H_i = nn.Parameter(torch.randn(self.M, 8))
