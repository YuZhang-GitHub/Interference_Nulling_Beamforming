...
class envCB:
    ...
    def reward_fn(self):
        ...
        bf_gain_t = self.BF_GAIN(self.bf_vec, self.ch_t)
        bf_gain_i = self.BF_GAIN(self.bf_vec, self.ch_i)
        bf_gain = 10 * torch.log10(torch.div(bf_gain_t, bf_gain_i))
    ...
    def get_reward(self, input_action):
        ...
        bf_gain_t = self.BF_GAIN(inner_bf, self.ch_t)
        bf_gain_i = self.BF_GAIN(inner_bf, self.ch_i)
        bf_gain = 10 * torch.log10(torch.div(bf_gain_t, bf_gain_i))
